            ...
            <div className ="footer">
                ...
                <div className="footer__main">
                    ...
                    <div className="footer__partner">
                        ...
                        <a href="https://planssurlacomete.fr/" target="_blank">
                            <img className="footer__partner--pslc" src={logo_pslc} alt="pslc_logo" href=""/>
                        </a>
                        <a href="https://www.youtube.com/channel/UCNyI0kceUUNeT2wv-rzKGHQ" target="_blank">
                            <img className="footer__partner--broccoli" src={logo_broccoli} alt="pslc_logo" href=""/>
                        </a>
                    </div>


                    <div className="footer__networks">
                        <a href="https://www.youtube.com/channel/UC2anhXu9pf90wkk9p2A_ojQ" target="_blank">
                            <img src={logo_yt} alt="yt_logo"/>
                        </a>
                        <a href="https://twitter.com/AsylumHeroes" target="_blank">
                            <img src={logo_twitter} alt="tw_logo"/>
                        </a>
                        <a href="https://www.facebook.com/AsylumYT" target="_blank">
